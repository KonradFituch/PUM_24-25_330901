...
@Composable
fun PlayerDetailsScreen(playerId: Int, navController: NavController) {
    // Lista zawodników
    val players = listOf(
    ...
    // Znajdowanie zawodnika na podstawie ID
    ...
    Box(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            Box(
                ...
                player?.let {
                    // Łączenie wszystkich danych w jeden tekst
                    val playerDetails = """
                    Name: ${it.name}
                ...
                """.trimIndent()
                    ...
                    // Wyświetlanie wszystkich danych w jednym przycisku
                    Text(
                        text = playerDetails,
                        fontSize = 20.sp,
                        lineHeight = 60.sp,
